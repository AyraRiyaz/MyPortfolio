            ...
            >
              ...
              >
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-primary-500 text-white px-8 py-3 rounded-full font-semibold flex items-center gap-2 hover:bg-primary-400 transition-all shadow-lg hover:shadow-primary-500/25"
                >
                  <Eye size={20} />
                  View Resume
                </motion.button>
